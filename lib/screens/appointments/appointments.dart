...
class Apppointments extends StatefulWidget {
  Apppointments({Key key}) : super(key: key);

  @override
  _AppointmentsState createState() {
    return _AppointmentsState();
  }
}

class _AppointmentsState extends State<Apppointments> {
